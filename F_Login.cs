...
namespace CFB_Academia
{
    public partial class F_Login : Form
    {
        ...
        private void btn_logar_Click(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count == 1)
            {
                form1.lb_acesso.Text = dt.Rows[0].ItemArray[5].ToString(); // primeira maneira de acesso
                form1.lb_nomeUsuario.Text = dt.Rows[0].Field<string>("T_NOMEUSUARIO"); // segunda maneira de acesso
