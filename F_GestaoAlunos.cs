...
";
        ...
        private void btn_ecluirAluno_Click(object sender, EventArgs e)
        {
            if(MessageBox.Show("Confirmar Exclusao?","Excluir?", MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
                ...
                WHERE
                    N_IDALUNO={0}
                ",idSelecionado);
                Banco.dql(vqueryExcluirAluno);
                dgv_alunos.Rows.Remove(dgv_alunos.CurrentRow);
            }
        }

        private void btn_fincanceiro_Click(object sender, EventArgs e)
        {
        ...
        private void btn_imprimirCarteir_Click(object sender, EventArgs e)
        {
